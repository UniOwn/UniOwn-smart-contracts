...
contract ComplexUniOwnNFT is WrapUniOwnNFT, Royalty, IComplexUniOwnNFT {
    ...
    function checkIn(
        ...
        uint256 tokenId,
        uint256 durationId
    ) public virtual override(BaseUniOwnNFT, IBaseUniOwnNFT) {
        BaseUniOwnNFT.checkIn(to, tokenId, durationId);
        IERC4907(oNftAddress).setUser(
            uniOwnNFTMapping[tokenId].oid,
            to,
    ...
    {
        return
            interfaceId == type(IComplexUniOwnNFT).interfaceId ||
